...
from collector.views import course_index, view_course, view_assignment, view_submission, submit_assignment, view_about
...
urlpatterns = patterns('',
    ...
    (r'^$', course_index),
    (r'^(?P<year>\d{4})/$', course_index),
    (r'^(?P<year>\d{4})/(?P<term>(?i)(summer|spring|winter|fall))/$', course_index),
