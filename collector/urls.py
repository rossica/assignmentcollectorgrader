...
urlpatterns = patterns('',
    ...
    (r'^(?P<course_id>[A-Za-z]{1,4}\d{3}[A-Za-z]?)/(?P<assn_name>[A-Za-z0-9_\-]+)/$', view_assignment),
    (r'^(?P<course_id>[A-Za-z]{1,4}\d{3}[A-Za-z]?)/(?P<assn_name>[A-Za-z0-9_\-]+)/submit/$', submit_assignment),
)