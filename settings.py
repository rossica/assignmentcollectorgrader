...
# Django settings for AssignmentCollectorGrader project.
import os

DEBUG = True
TEMPLATE_DEBUG = DEBUG
PROJECT_ROOT = os.path.realpath(os.path.dirname(__file__))
JUNIT_ROOT = PROJECT_ROOT + os.sep + "junit482" + os.sep + "junit-4.8.2.jar"
...
DATABASES = {
    'default': {
        ...
        'NAME': PROJECT_ROOT +'/collectorgrader.db',                      # Or path to database file if using sqlite3.
...
# Uncomment the lines below for a production deployment
